          ...
          child: Center(
            child: ConstrainedBox(
              ...
              child: Column(
                ...
                children: [
                  SizedBox(
                    height: MediaQuery.of(context).size.height * 0.45, // Adjust height for the image
                    child: ClipPath(
                      clipper: ArcClipper(),
                      child: Container(
                  ...
                  const SizedBox(height: 20), // Reduced spacing above the text
                  const Padding(
                  ...
                  const SizedBox(height: 20), // Spacing above the first text field
                  Padding(
                  ...
                  const SizedBox(height: 20), // Spacing below the password field
                  const SizedBox(height: 10), // Reduced spacing above the "¿No tienes cuenta?" text
                  GestureDetector(
                    onTap: () {
                      Navigator.pushNamed(
                        context,
                        '/registro',
                        arguments: {'from': 'iniciar'}, // Pass argument indicating source
                      );
                    },
                    child: const Text(
                  ...
                  const SizedBox(height: 20), // Spacing above the "Volver" button
                  Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 20),
                    child: CustomButton(
                      text: 'Volver',
                      onPressed: () {
                        Navigator.pushNamed(context, '/inicio'); // Navigate back to Inicio
                      },
                    ),
                  ),
                ],
